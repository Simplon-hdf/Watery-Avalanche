 ...
 */
final class Version20221005081144 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE person (id BIGSERIAL NOT NULL, name VARCHAR(100) NOT NULL, country VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
